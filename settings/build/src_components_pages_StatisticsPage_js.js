"use strict";
(self["webpackChunkburst_statistics"] = self["webpackChunkburst_statistics"] || []).push([["src_components_pages_StatisticsPage_js"],{
...
const getAcquisitionData = async _ref => {
  let {
    type,
    startDate,
    endDate,
...
const transformCompareData = response => {
  ...
  Object.entries(selectedMetrics).forEach(_ref => {
    let [key, value] = _ref;
 ...
 * @returns {Promise<*>}
 */
const getCompareData = async _ref2 => {
  let {
    startDate,
    endDate,
    range,
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   transformDevicesData: () => (/* binding */ transformDevicesData)
/* harmony export */ });
...
const transformDevicesData = response => {
  let data = {};
 ...
 * @returns {Promise<*>}
 */
const getDevicesData = async _ref => {
  let {
    startDate,
    endDate,
    range,
  ...
  const {
    data
  } = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_1__.getData)('devices', startDate, endDate, range, args);
  return transformDevicesData(data);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getDevicesData);
 ...
 * @returns {Promise<*>}
 */
const getInsightsData = async _ref => {
  let {
    startDate,
    endDate,
    range,
...
const transformPagesData = response => {
  ...
  if (query.isFetched && data.length !== 0 && data.columns) {
    ...
    if (type === 'countries') {
      data.columns[0].cell = row => {
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Flag__WEBPACK_IMPORTED_MODULE_10__["default"], {
...
/* harmony import */ var _store_useGoalFieldsStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store/useGoalFieldsStore */ "./src/store/useGoalFieldsStore.js");
...
const ClickToFilter = _ref => {
  ...
  const setFilters = (0,_store_useFiltersStore__WEBPACK_IMPORTED_MODULE_2__.useFiltersStore)(state => state.setFilters);
  const setAnimate = (0,_store_useFiltersStore__WEBPACK_IMPORTED_MODULE_2__.useFiltersStore)(state => state.setAnimate);
  const goalFields = (0,_store_useGoalFieldsStore__WEBPACK_IMPORTED_MODULE_3__.useGoalFieldsStore)(state => state.goalFields);
  const setInsightsMetrics = (0,_store_useInsightsStore__WEBPACK_IMPORTED_MODULE_4__.useInsightsStore)(state => state.setMetrics);
  const insightsMetrics = (0,_store_useInsightsStore__WEBPACK_IMPORTED_MODULE_4__.useInsightsStore)(state => state.metrics);
  const setStartDate = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.setStartDate);
  const setEndDate = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.setEndDate);
  const setRange = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.setRange);
  ...
  const handleClick = async event => {
    ...
    if (startDate && (typeof startDate === 'number' || Date.parse(startDate) >= MIN_START_DATE * 1000)) {
      selectedStartDate = typeof startDate === 'number' ? (0,_utils_formatting__WEBPACK_IMPORTED_MODULE_8__.formatUnixToDate)(startDate) : startDate;
    }
    if (selectedStartDate) {
      const selectedEndDate = endDate ? endDate > 0 ? (0,_utils_formatting__WEBPACK_IMPORTED_MODULE_8__.formatUnixToDate)(endDate) : endDate : (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(new Date(), 'yyyy-MM-dd');
      setStartDate(selectedStartDate);
      setEndDate(selectedEndDate);
      setRange('custom');
    }
  };
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_Tooltip__WEBPACK_IMPORTED_MODULE_10__["default"], {
    title: tooltip
...
/* harmony import */ var _store_useFiltersStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store/useFiltersStore */ "./src/store/useFiltersStore.js");
...
/* harmony import */ var _common_ExplanationAndStatsItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/ExplanationAndStatsItem */ "./src/components/common/ExplanationAndStatsItem.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _common_GridItem__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../common/GridItem */ "./src/components/common/GridItem.js");
/* harmony import */ var _CompareFooter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CompareFooter */ "./src/components/blocks/CompareFooter.js");
/* harmony import */ var _store_useInsightsStore__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../store/useInsightsStore */ "./src/store/useInsightsStore.js");
/* harmony import */ var _tanstack_react_query__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @tanstack/react-query */ "./node_modules/@tanstack/react-query/build/lib/useQuery.mjs");
/* harmony import */ var _api_getInsightsData__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../api/getInsightsData */ "./src/api/getInsightsData.js");
/* harmony import */ var _api_getCompareData__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../api/getCompareData */ "./src/api/getCompareData.js");
...
const CompareBlock = () => {
  ...
  const {
    ...
    endDate,
    range
  } = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_4__.useDate)(state => state);
  const filters = (0,_store_useFiltersStore__WEBPACK_IMPORTED_MODULE_3__.useFiltersStore)(state => state.filters);
  const args = {
    'filters': filters
  };
  const metrics = {
    'pageviews': (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Pageviews', 'burst-statistics'),
    'sessions': (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Sessions', 'burst-statistics'),
    'visitors': (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Visitors', 'burst-statistics'),
    'bounced_sessions': (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Bounce Rate', 'burst-statistics')
  };
  let emptyData = {};
  ...
  const query = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_12__.useQuery)({
    ...
    queryFn: () => (0,_api_getCompareData__WEBPACK_IMPORTED_MODULE_11__["default"])({
      startDate,
      endDate,
      range,
      args
  ...
  let loadingClass = loading ? 'burst-loading' : '';
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_common_GridItem__WEBPACK_IMPORTED_MODULE_7__["default"], {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Compare', 'burst-statistics'),
    footer: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_CompareFooter__WEBPACK_IMPORTED_MODULE_8__["default"], {
      startDate: startDate,
      endDate: endDate
    })
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    let m = data[key];
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_common_ExplanationAndStatsItem__WEBPACK_IMPORTED_MODULE_5__["default"], {
      key: i,
      iconKey: key,
      title: m.title,
      subtitle: m.subtitle,
...
const CompareFooter = _ref => {
  ...
  const text = days === 1 ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('vs. previous day', 'burst-statistics') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('vs. previous %s days', 'burst-statistics');
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _mui_material_Popover__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @mui/material/Popover */ "./node_modules/@mui/material/Popover/Popover.js");
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/startOfYear/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/addYears/index.js");
...
const currentDateWithOffset = (0,_utils_formatting__WEBPACK_IMPORTED_MODULE_6__.getDateWithOffset)();
function isSelected(range) {
  const definedRange = this.range();
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(range.startDate, definedRange.startDate) && (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(range.endDate, definedRange.endDate);
}
const availableRanges = {
  'today': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Today', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(currentDateWithOffset),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(currentDateWithOffset)
    })
  },
  'yesterday': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Yesterday', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -1)),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -1))
    })
  },
  'last-7-days': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Last 7 days', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -7)),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -1))
    })
  },
  'last-30-days': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Last 30 days', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -30)),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -1))
    })
  },
  'last-90-days': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Last 90 days', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -90)),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -1))
    })
  },
  'last-month': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Last month', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_11__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_12__["default"])(currentDateWithOffset, -1)),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_13__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_12__["default"])(currentDateWithOffset, -1))
    })
  },
  'week-to-date': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Week to date', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(currentDateWithOffset, -currentDateWithOffset.getDay())),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(currentDateWithOffset)
    })
  },
  'month-to-date': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Month to date', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_11__["default"])(currentDateWithOffset),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(currentDateWithOffset)
    })
  },
  'year-to-date': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Year to date', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_14__["default"])(currentDateWithOffset),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(currentDateWithOffset)
    })
  },
  'last-year': {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Last year', 'burst-statistics'),
    range: () => ({
      startDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_14__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_15__["default"])(currentDateWithOffset, -1)),
      endDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_16__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_15__["default"])(currentDateWithOffset, -1))
    })
  }
};
const DateRange = props => {
  ...
  const startDate = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.startDate);
  const endDate = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.endDate);
  const setStartDate = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.setStartDate);
  const setEndDate = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.setEndDate);
  const range = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.range);
  const setRange = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state.setRange);
  const [selectionRangeStartDate, setSelectionRangeStartDate] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)((0,date_fns__WEBPACK_IMPORTED_MODULE_17__["default"])(startDate));
  const [selectionRangeEndDate, setSelectionRangeEndDate] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)((0,date_fns__WEBPACK_IMPORTED_MODULE_17__["default"])(endDate));
  ...
  const dateRanges = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
  ...
  const updateDateRange = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(ranges => {
    countClicks.current++;
    const {
      startDate,
      endDate
    } = ranges.selection;
    const startStr = (0,date_fns__WEBPACK_IMPORTED_MODULE_18__["default"])(startDate, 'yyyy-MM-dd');
    const endStr = (0,date_fns__WEBPACK_IMPORTED_MODULE_18__["default"])(endDate, 'yyyy-MM-dd');
    setSelectionRangeStartDate((0,date_fns__WEBPACK_IMPORTED_MODULE_17__["default"])(startStr));
    setSelectionRangeEndDate((0,date_fns__WEBPACK_IMPORTED_MODULE_17__["default"])(endStr));
    const selectedRangeKey = Object.keys(availableRanges).find(key => availableRanges[key].isSelected(ranges.selection));
  ...
  const display = {
    startDate: startDate ? (0,date_fns__WEBPACK_IMPORTED_MODULE_18__["default"])(new Date(startDate), formatString) : (0,date_fns__WEBPACK_IMPORTED_MODULE_18__["default"])(defaultStart, formatString),
    endDate: endDate ? (0,date_fns__WEBPACK_IMPORTED_MODULE_18__["default"])(new Date(endDate), formatString) : (0,date_fns__WEBPACK_IMPORTED_MODULE_18__["default"])(defaultEnd, formatString)
  };
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    name: "chevron-down"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_Popover__WEBPACK_IMPORTED_MODULE_19__["default"], {
    anchorEl: anchorEl,
    anchorOrigin: {
      vertical: 'bottom',
      horizontal: 'right'
...
/* harmony import */ var _common_ExplanationAndStatsItem__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../common/ExplanationAndStatsItem */ "./src/components/common/ExplanationAndStatsItem.js");
/* harmony import */ var _tanstack_react_query__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @tanstack/react-query */ "./node_modules/@tanstack/react-query/build/lib/useQuery.mjs");
/* harmony import */ var _api_getDevicesData__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../api/getDevicesData */ "./src/api/getDevicesData.js");
...
const DevicesBlock = () => {
  ...
  const query = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_12__.useQuery)({
    ...
    queryFn: () => (0,_api_getDevicesData__WEBPACK_IMPORTED_MODULE_11__["default"])({
      startDate,
      endDate,
      range,
      args
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_common_GridItem__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    let m = data[key];
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ClickToFilter__WEBPACK_IMPORTED_MODULE_6__["default"], {
      key: key,
      filter: "device",
      filterValue: key,
      label: m.title
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_common_ExplanationAndStatsItem__WEBPACK_IMPORTED_MODULE_10__["default"], {
      iconKey: key,
      title: m.title,
      subtitle: m.subtitle,
      value: m.value,
...
/* harmony import */ var _ProPopover__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../ProPopover */ "./src/components/blocks/ProPopover.js");
/* harmony import */ var _ProPill__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ProPill */ "./src/components/blocks/ProPill.js");
...
const AcquisitionSwitch = _ref => {
  ...
  const options = [{
    value: 'referrers',
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Referrers', 'burst-statistics'),
    icon: 'referrers',
    pro: false
  }, {
    value: 'countries',
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Countries', 'burst-statistics'),
    icon: 'world',
    pro: true
  }];
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    if (disabled) {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ProPopover__WEBPACK_IMPORTED_MODULE_4__["default"], {
        key: option.value,
        className: className,
        onClick: () => {
          if (!disabled) {
        ...
        name: option.icon,
        size: 13
      }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, option.label), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ProPill__WEBPACK_IMPORTED_MODULE_5__["default"], null));
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(AcquisitionSwitch));
...
/* harmony import */ var _api_getInsightsData__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../api/getInsightsData */ "./src/api/getInsightsData.js");
/* harmony import */ var _store_useFiltersStore__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../store/useFiltersStore */ "./src/store/useFiltersStore.js");
...
const InsightsBlock = () => {
  const [InsightsGraph, setInsightsGraph] = (0,react__WEBPACK_IMPORTED_MODULE_6__.useState)(null);
  (0,react__WEBPACK_IMPORTED_MODULE_6__.useEffect)(() => {
    if (!InsightsGraph) {
      Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_react-chartjs-2_dist_index_js"), __webpack_require__.e("src_components_blocks_InsightsGraph_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./InsightsGraph */ "./src/components/blocks/InsightsGraph.js")).then(_ref => {
        let {
  ...
  const metrics = (0,_store_useInsightsStore__WEBPACK_IMPORTED_MODULE_4__.useInsightsStore)(state => state.metrics);
  const {
    startDate,
    endDate,
    range
  } = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_5__.useDate)(state => state);
  const filters = (0,_store_useFiltersStore__WEBPACK_IMPORTED_MODULE_8__.useFiltersStore)(state => state.filters);
  const args = {
    'filters': filters,
    'metrics': metrics
  };
  const query = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_9__.useQuery)({
    queryKey: ['insights', metrics, startDate, endDate, args],
    queryFn: () => (0,_api_getInsightsData__WEBPACK_IMPORTED_MODULE_7__["default"])({
      startDate,
      endDate,
      range,
      args
...
const InsightsHeader = _ref => {
  let {
    metrics,
    filters
  } = _ref;
  const [anchorEl, setAnchorEl] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
  const setMetrics = (0,_store_useInsightsStore__WEBPACK_IMPORTED_MODULE_5__.useInsightsStore)(state => state.setMetrics);
  const [pendingMetrics, setPendingMetrics] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(metrics);
  let metricLabels = {
    visitors: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Unique visitors', 'burst-statistics'),
    pageviews: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Pageviews', 'burst-statistics'),
    bounces: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Bounces', 'burst-statistics'),
  ...
  if (filters.goal_id > 0) {
    ...
    metricLabels.conversions = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Conversions', 'burst-statistics');
  }
  const handleClick = e => {
    setAnchorEl(e.currentTarget);
  };
  ...
  const handleCheckboxChange = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(event => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Button, {
    ...
    name: "filter"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_mui_material_Popover__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    open: open,
    onClose: handleClose
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select metrics', 'burst-statistics')), Object.keys(metricLabels).map(metric => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "burst-filter-dropdown-content-body-item",
    key: metric
  ...
  }), metricLabels[metric]))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "hidden",
    name: "burst-metrics",
    value: metrics
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Apply', 'burst-statistics'))));
};
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _store_useGoalFieldsStore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../store/useGoalFieldsStore */ "./src/store/useGoalFieldsStore.js");
/* harmony import */ var _store_useInsightsStore__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../store/useInsightsStore */ "./src/store/useInsightsStore.js");
...
const PageFilter = () => {
  ...
  const goalFields = (0,_store_useGoalFieldsStore__WEBPACK_IMPORTED_MODULE_4__.useGoalFieldsStore)(state => state.goalFields);
  ...
  const insightsMetrics = (0,_store_useInsightsStore__WEBPACK_IMPORTED_MODULE_5__.useInsightsStore)(state => state.metrics);
  let title = '';
...
const ProPopover = _ref => {
  ...
  const [firstHover, setFirstHover] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_radix_ui_react_popover__WEBPACK_IMPORTED_MODULE_4__.Root, {
    open: open,
    onOpenChange: setOpen
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_radix_ui_react_popover__WEBPACK_IMPORTED_MODULE_4__.Trigger, {
    className: className,
    onMouseEnter: openInFirstHover,
    onClick: onClick
  }, children), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_radix_ui_react_popover__WEBPACK_IMPORTED_MODULE_4__.Portal, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_radix_ui_react_popover__WEBPACK_IMPORTED_MODULE_4__.Content, {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_radix_ui_react_popover__WEBPACK_IMPORTED_MODULE_4__.Close, {
    className: 'burst-pro-popover__close'
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_Icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    name: 'times'
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Unlock Country Insights with Pro', 'burst-statistics')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h6", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Get detailed information on your users', 'burst-statistics'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: 'burst-pro-popover__bullet-list'
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: 'burst-small-text'
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Pro features include:', 'burst-statistics')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_Icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    name: 'world'
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("b", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('See Countries:', 'burst-statistics')), " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Know where your visitors are from.', 'burst-statistics'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_Icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    name: 'goals'
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("b", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Track More Goals:', 'burst-statistics')), " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Follow different things at the same time.', 'burst-statistics'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_Icon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    name: 'filters'
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("b", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Filter by Country:', 'burst-statistics')), " ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Only see data from specific places.', 'burst-statistics')))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: 'burst-pro-popover__footer'
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: 'https://burst-statistics.com/pricing/?src=countries-upsell',
    target: "_blank",
    className: 'burst-button burst-button--pro'
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Upgrade to Pro', 'burst-statistics')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: 'https://burst-statistics.com/?src=countries-upsell',
    target: "_blank",
    className: 'burst-button burst-button--secondary'
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Learn More', 'burst-statistics'))))));
};
...
const ExplanationAndStatsItem = _ref => {
  let {
    iconKey,
    title,
    subtitle,
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _blocks_Filters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../blocks/Filters */ "./src/components/blocks/Filters.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _blocks_PageFilter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../blocks/PageFilter */ "./src/components/blocks/PageFilter.js");
/* harmony import */ var _blocks_DateRange__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../blocks/DateRange */ "./src/components/blocks/DateRange.js");
/* harmony import */ var _store_useFiltersStore__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../store/useFiltersStore */ "./src/store/useFiltersStore.js");
/* harmony import */ var _store_useDateStore__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../store/useDateStore */ "./src/store/useDateStore.js");
...
const StatisticsPage = () => {
  const {
    filters
  } = (0,_store_useFiltersStore__WEBPACK_IMPORTED_MODULE_10__.useFiltersStore)(state => ({
  ...
  const {
    ...
    endDate,
    range
  } = (0,_store_useDateStore__WEBPACK_IMPORTED_MODULE_11__.useDate)(state => ({
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_blocks_Filters__WEBPACK_IMPORTED_MODULE_1__.Filters, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_blocks_PageFilter__WEBPACK_IMPORTED_MODULE_8__.PageFilter, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_blocks_DateRange__WEBPACK_IMPORTED_MODULE_9__["default"], null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_blocks_InsightsBlock__WEBPACK_IMPORTED_MODULE_3__["default"], {
    filters: filters
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_blocks_CompareBlock__WEBPACK_IMPORTED_MODULE_4__["default"], commonProps), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_blocks_DevicesBlock__WEBPACK_IMPORTED_MODULE_5__["default"], commonProps), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_blocks_PagesBlock__WEBPACK_IMPORTED_MODULE_6__["default"], commonProps), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_blocks_AcquisitionBlock__WEBPACK_IMPORTED_MODULE_7__["default"], commonProps));
};
...
// define the store
const useAcquisitionStore = (0,zustand__WEBPACK_IMPORTED_MODULE_0__.create)((set, get) => ({
  type: 'referrers',
  setType: type => set(() => ({
    type: type
  }))
...
const useFiltersStore = (0,zustand__WEBPACK_IMPORTED_MODULE_2__.create)((set, get) => ({
  ...
  setFilters: function (filter, value) {
...
// define the store
const useInsightsStore = (0,zustand__WEBPACK_IMPORTED_MODULE_0__.create)((set, get) => ({
