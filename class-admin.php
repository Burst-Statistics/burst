...
if ( ! class_exists( "burst_admin" ) ) {
	class burst_admin {
		...
		function __construct() {
			...
			// remove today block
			add_filter( 'burst_grid_items', array($this, 'filter_grid_items' ));
		...
		public function register_admin_page() {
			...
			$warning_count = count( $warnings ) > 0 ? count( $warnings ) : 0;
		...
		// remove today block
		function filter_grid_items( $grid_items ) {

			unset( $grid_items['dashboard'][2] );
