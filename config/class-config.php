		...
		public function notices($notices){
			$new_notices = [
				...
				'new-feature-turbo-mode' => [
					...
					'plus_one' => true,
					'new' => __( "We have improved the tracking and added Turbo mode! Tracking has become faster and more accurate. Want an even faster page load? Enable Turbo Mode. Caution: Turbo mode can be less accurate.", 'burst-statistics' ) . burst_read_more('https://burst-statistics.com/new-feature-tracking-with-endpoint', __('Learn more', 'burst-statistics')),
					'include_in_progress' => true,
					'dismissible' => true,
				],
				'leave_feedback' => [
