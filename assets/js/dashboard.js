jQuery(document).ready(function ($) {
    ...
    function initDatePicker() {
        ...
        var strExperiment = burstLocalizeString('Experiment duration');
    ...
    $(document).on('change', 'select[name=burst_selected_metric]', function(){
        var datepickerData = $('.burst-date-container.burst-date-range').data('daterangepicker');
        var startDate = moment(datepickerData.startDate);
        var endDate = moment(datepickerData.endDate);
